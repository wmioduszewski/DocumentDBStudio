...
namespace Microsoft.Azure.DocumentDBStudio.Util
{
        ...
        public static object GetReflectedPropertyValue(this object obj, string propertyName)
        {
            ...
            if (propInfo == null)
                throw new ArgumentOutOfRangeException("propertyName",
                    string.Format(CultureInfo.InvariantCulture, "Couldn't find property {0} in type {1}", propertyName,
                        objType.FullName));
    ...
    internal static class DocumentClientExtension
    {
        ...
        public static Task<ResourceResponse<DocumentCollection>> ReplaceDocumentCollectionExAsync(
            this DocumentClient client, DocumentCollection collection, RequestOptions options = null)
        {
        ...
        /// <param name="options">the request options for the request.</param>
        /// <returns>The task object representing the service response for the asynchronous operation.</returns>
        public static Task<ResourceResponse<Attachment>> ReplaceAttachmentExAsync(this DocumentClient client,
            Attachment attachment, RequestOptions options = null)
        {
        ...
        /// <param name="options">the request options for the request.</param>
        /// <returns>The task object representing the service response for the asynchronous operation.</returns>
        public static Task<ResourceResponse<StoredProcedure>> ReplaceStoredProcedureExAsync(this DocumentClient client,
            StoredProcedure storedProcedure, RequestOptions options = null)
        {
        ...
        /// <param name="options">the request options for the request.</param>
        /// <returns>The task object representing the service response for the asynchronous operation.</returns>
        public static Task<ResourceResponse<Trigger>> ReplaceTriggerExAsync(this DocumentClient client, Trigger trigger,
        ...
        /// <param name="options">the request options for the request.</param>
        /// <returns>The task object representing the service response for the asynchronous operation.</returns>
        public static Task<ResourceResponse<UserDefinedFunction>> ReplaceUserDefinedFunctionExAsync(
            this DocumentClient client, UserDefinedFunction function, RequestOptions options = null)
        {
        ...
        /// <param name="options">the request options for the request.</param>
        /// <returns>The task object representing the service response for the asynchronous operation.</returns>
        public static Task<ResourceResponse<Permission>> ReplacePermissionExAsync(this DocumentClient client,
            Permission permission, RequestOptions options = null)
        {
        ...
        /// <param name="options">the request options for the request.</param>
        /// <returns>The task object representing the service response for the asynchronous operation.</returns>
        public static Task<ResourceResponse<User>> ReplaceUserExAsync(this DocumentClient client, User user,
            RequestOptions options = null)
        {
